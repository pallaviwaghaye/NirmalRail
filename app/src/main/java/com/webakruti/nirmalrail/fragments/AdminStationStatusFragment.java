...
public class AdminStationStatusFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_admin_station_status, container, false);
            ...
            public void onResponse(Call<MyRequestStatusResponse> call, Response<MyRequestStatusResponse> response) {
                if (response.isSuccessful() && response.body() != null && response.code() == 200) {
                    ...
                    if (details.getSuccess().getStatus() && details.getSuccess().getStation() != null && details.getSuccess().getStation().size() > 0) {
                        ...
                        adminStationStatusAdapter = new AdminStationStatusAdapter(getActivity(), list);
                        recyclerView.setAdapter(adminStationStatusAdapter);
                    } else {
