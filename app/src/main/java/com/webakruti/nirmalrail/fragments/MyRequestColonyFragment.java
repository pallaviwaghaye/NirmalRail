...
public class MyRequestColonyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_my_request_colony, container, false);
            ...
            public void onResponse(Call<MyRequestStatusResponse> call, Response<MyRequestStatusResponse> response) {
                if (response.isSuccessful() && response.body() != null && response.code() == 200) {
                    ...
                    if (details.getSuccess().getStatus() && details.getSuccess().getColony() != null && details.getSuccess().getColony().size() > 0) {
                        ...
                        myRequestStatusAdapter = new MyRequestColonyStatusAdapter(getActivity(), list);
