...
public class AdminHomeActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewInProgress.setTextSize(Utils.pixelToDp(AdminHomeActivity.this, 28));
        textViewInProgress.setTypeface(null, Typeface.NORMAL);

        textViewCompleted.setTextSize(Utils.pixelToDp(AdminHomeActivity.this, 28));
        textViewCompleted.setTypeface(null, Typeface.NORMAL);

        textViewInvalid.setTextSize(Utils.pixelToDp(AdminHomeActivity.this, 28));
    ...
    private void callGetDataAPI(String statusType) {
        ...
        switch (statusType) {
            ...
            case IN_PROGRESS:
                ...
                textViewNew.setTextSize(Utils.pixelToDp(AdminHomeActivity.this, 28));
